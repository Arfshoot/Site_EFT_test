...
import { GET_USER, UPDATE_ADRESS, UPDATE_AGE, UPDATE_BROKER, UPDATE_CATEGORIESP, UPDATE_CODEPOSTAL, UPDATE_COMPLMTADRESS, UPDATE_CONNU, UPDATE_EMAIL, UPDATE_ETATPROV, UPDATE_FIRSTNAME, UPDATE_LASTNAME, UPDATE_PAYS, UPDATE_PHONE, UPDATE_RAISONS, UPDATE_ROLE, UPDATE_SATUT, UPDATE_SECONDNAME, UPDATE_USERIP, UPDATE_VILLE } from '../actions/user.actions';
